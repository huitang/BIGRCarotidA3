 ...
 *
 *=========================================================================*/
#ifndef __itkGeodesicActiveContourAndRegionCalciumRemovalLevelSetImageFilter_hxx
#define __itkGeodesicActiveContourAndRegionCalciumRemovalLevelSetImageFilter_hxx

#include "itkGeodesicActiveContourAndRegionCalciumRemovalLevelSetImageFilter.h"

namespace itk
{
template< class TInputImage, class TFeatureImage,class TSimilarityImage, class TOutputType >
GeodesicActiveContourAndRegionCalciumRemovalLevelSetImageFilter< TInputImage, TFeatureImage, TSimilarityImage, TOutputType >
::GeodesicActiveContourAndRegionCalciumRemovalLevelSetImageFilter()
{
