...
int main (int argc, char ** argv) {
  ...
  help.push_back(" Author: Hui Tang, Reinhard Hameeteman");
  ...
  if ( useMask ) {
    ...
    {
      std::cout<<"Error:original and mask image should have the same size" << std::endl;
      return EXIT_FAILURE;
    }
  }
  ...
  if (  vm.count("threshold")* 
      ...
      medialnessImageFilter->SetVerbose( true );
      ...
      {
          writer->Update();
          std::cout << "The medialness image of " 
                    << inputImageN 
                    << " is saved as a name of" 
                    << outputMedialnessN 
                    << std::endl;
      }
      catch ( itk::ExceptionObject &err)
